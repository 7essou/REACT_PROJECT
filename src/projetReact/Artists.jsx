...
export default function Artists(){
    ...
    const Artists = useSelector(s=>s.artists).filter(e=>e.id!=iduser&&e.Categorie.toLocaleLowerCase().includes(categorie.toLocaleLowerCase()) && e.Nickname.toLocaleLowerCase().includes(rech.toLocaleLowerCase()) && e.city.toLocaleLowerCase().includes(city.toLocaleLowerCase()))
